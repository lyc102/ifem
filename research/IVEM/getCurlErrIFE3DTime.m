function [err,errK1,errK2,errK3] = getCurlErrIFE3DTime(uh, pde, mesh, fem, femI, eNorm,T)
...
if strcmp(eNorm,'L2')
    dind = 0;
    fun1 = @(x,y,z) pde.exactu1(x,y,z,T); 
    fun2 = @(x,y,z) pde.exactu2(x,y,z,T); 
    fun3 = @(x,y,z) pde.exactu3(x,y,z,T); 
elseif strcmp(eNorm,'Curl')
    dind = 1;
    fun1 = @(x,y,z) pde.Dxu(x,y,z,T); 
    fun2 = @(x,y,z) pde.Dyu(x,y,z,T); 
    fun3 = @(x,y,z) pde.Dzu(x,y,z,T); 
end
