function pde = ConstFunHM(am,ap,bm,bp,kappa,r1,r2,r3,x0,y0,z0)
...
%% right hand side function
    ...
    function u = fm1(x,y,z)
        u = -r1*ones(size(x))*kappa;
    end
    function u = fm2(x,y,z)
        u = -r2*ones(size(x))*kappa;
    end
    function u = fm3(x,y,z)
        u = -r3*ones(size(x))*kappa;
    end
