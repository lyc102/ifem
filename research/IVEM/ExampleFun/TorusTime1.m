function pde = TorusTime(mum,mup,sigm,sigp,epsm,epsp,omega,stre,x0,y0,z0,r1,r2)
...
%% right hand side function
    ...
    function u = fm1(x,y,z,t)
        u = -2*pi*omega*sin(myacos(x,y))*cos(2*pi*omega*t)*stre;
    end
    function u = fm2(x,y,z,t)
        u = 2*pi*omega*cos(myacos(x,y))*cos(2*pi*omega*t)*stre;
    end
