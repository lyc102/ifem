function pde = elli3DtorusTwinHcurl2(am,ap,bm,bp,x1,y1,z1,r11,r12,x2,y2,z2,r21,r22)
...
%% exact solution
    ...
    function u = um3(x,y,z)
        u = DFz(x,y,z)/bm + sin(intf2(x,y,z)/am);
    end
    ...
    function u = up3(x,y,z)
        u = DFz(x,y,z)/bp + sin(intf2(x,y,z)/ap);
    end
...
%% Derivative of the exact solution
    ...
    function u = Dxum(x,y,z)
        u = cos(intf2(x,y,z)/am).*DFy(x,y,z)/am;
    end
    function u = Dyum(x,y,z)
        u = cos(intf2(x,y,z)/am).*(-DFx(x,y,z))/am;
    end
    function u = Dzum(x,y,z)
        u = zeros(size(x));
    end
    function u = Dxup(x,y,z)
        u = cos(intf2(x,y,z)/ap).*DFy(x,y,z)/ap;
    end
    function u = Dyup(x,y,z)
        u = cos(intf2(x,y,z)/ap).*(-DFx(x,y,z))/ap;
    end
...
%% right hand side function
    ...
    function u = fm1(x,y,z)
        u = bm*um1(x,y,z) + cos(intf2(x,y,z)/am).*DFxz(x,y,z) + ...
            -sin(intf2(x,y,z)/am).*DFx(x,y,z).*DFz(x,y,z)/am;
    end
    function u = fm2(x,y,z)
        u = bm*um2(x,y,z) +cos(intf2(x,y,z)/am).*DFyz(x,y,z) + ...
            -sin(intf2(x,y,z)/am).*DFy(x,y,z).*DFz(x,y,z)/am;
    end
    function u = fm3(x,y,z)
        u = bm*um3(x,y,z) + cos(intf2(x,y,z)/am).*(-DFxx(x,y,z)-DFyy(x,y,z)) + ...
            -sin(intf2(x,y,z)/am).*(-DFx(x,y,z).*DFx(x,y,z)-DFy(x,y,z).*DFy(x,y,z))/am;
    end
    function u = fp1(x,y,z)
        u = bp*up1(x,y,z) +cos(intf2(x,y,z)/ap).*DFxz(x,y,z) + ...
            -sin(intf2(x,y,z)/ap).*DFx(x,y,z).*DFz(x,y,z)/ap;
    end
    function u = fp2(x,y,z)
        u = bp*up2(x,y,z) +cos(intf2(x,y,z)/ap).*DFyz(x,y,z) + ...
            -sin(intf2(x,y,z)/ap).*DFy(x,y,z).*DFz(x,y,z)/ap;
    end
    function u = fp3(x,y,z)
        u = bp*up3(x,y,z) +cos(intf2(x,y,z)/ap).*(-DFxx(x,y,z)-DFyy(x,y,z)) + ...
            -sin(intf2(x,y,z)/ap).*(-DFx(x,y,z).*DFx(x,y,z)-DFy(x,y,z).*DFy(x,y,z))/ap;
    end
