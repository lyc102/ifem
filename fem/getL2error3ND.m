function err = getL2error3ND(node,elem,exactE,Eh,markedElem)
%% GETL2ERROR3ND L2 norm of the lowest order Nedelec edge element.
% 
%  err = GETL2ERROR3ND(node,elem,exactE,Eh,markedElem)
%
% Example
% 
