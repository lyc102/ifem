function [sigma,u,info] =  appfactpreHodgeLapE(M,G,C,f,g,node,elem,bdFlag,option)
%% APPFACTPREHODGELAPE: solve the Hodge Laplacian by an approximated factorization preconditioner 
%
...
time = cputime - t;
if printlevel >= 1
    fprintf('Approximated Factorization Preconditioned GMRES \n');
