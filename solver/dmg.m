function [sigma,u,info] = dmg(M,B,C,f,g,elem,option)
%% DMG Distributive Multigrid Methods for Saddle Point Problem
%
% [sigma,u] = dmg(M,B,C,f,g,elem) solves saddle point problem discretized
% from mixed FEM for Poisson equation.
% 
%      |M   B'| |sigma|  = |f|
%      |B  -C | |u|      = |g|
%
...
time = cputime - t;
if printlevel >= 1
    fprintf('Distributive MultiGrid Preconditioned GMRES \n');
