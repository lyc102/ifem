function [u,sigma,eqn,info] = PoissonRT1(node,elem,bdFlag,pde,option)
%% POISSONRT0 Poisson equation: 2nd order RT element.
%
%  [u,sigma] = PoissonRT1(node,elem,bdFlag,pde) produces an approximation of
...
M = getmassmatvec(elem2edge,area,Dlambda,'RT1',K);
