function [soln,eqn,info] = PoissonQ1(node,elem,bdFlag,pde,option)
%% POISSONQ1 Poisson equation: Q1 bilinear element.
%
%   u = PoissonQ1(node,elem,bdFlag,pde) produces the bilinear finite element
...
%   
% [soln,eqn,info] = PoissonQ1(node,elem,pde,bdFlag,option)
%
% The usage is the same as <a href="matlab:help Poisson">Poisson</a>. Quadratic element on a triangle is
% summarized in <a href="matlab:ifem PoissonfemrateP2">PoissonfemrateP2</a> for detail.
% 
%   Example
%     clear all
