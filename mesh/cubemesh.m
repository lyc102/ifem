...
%
% [node,elem,HB] = cubemesh([x0,x1,y0,y1,z0,z1]) generates a uniform mesh
...
% Example 1
%
%  [node,elem,HB] = cubemesh([-1,1,-1,1,-1,1]);
%  showmesh3(node,elem);
%
% Example 2
%
...
% 
% Example 3
% option.hx = 1/2; option.hy = 1/4; option.hz = 1;
%  [node,elem,HB] = cubemesh([-1,1,-1,1,-1,1],option);
%  showmesh3(node,elem);
